        ...
        <el-card>
            <el-row>
                <el-table :data="homeworks" stripe>
                    <el-table-column prop="1" label="我的作业"></el-table-column>
                    <el-table-column prop="2" label="提交次数"></el-table-column>
                    <el-table-column prop="3" label="成绩"></el-table-column>
                    <el-table-column prop="4" label="截至时间"></el-table-column>
                </el-table>
            </el-row>
